        ...
        E.plugin(function () {
            ...
            fns.onload || (fns.onload = function (resultText, xhr) {
                ...
                if (resultText.indexOf('error|') === 0) {
                    ...
                    img.onload = function () {
                        var html = '<img src="http://image.yinxindata.com/' + resultText + '" alt="' + originalName + '" style="max-width:100%;"/>';
                        editor.command(null, 'insertHtml', html);

                        E.log('已插入图片，地址 http://image.yinxindata.com/' + resultText);
                        img = null;
                    };
                    ...
                    img.src = 'http://image.yinxindata.com/' + resultText;
                }
    ...
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            function insertImg(src, event) {
                ...
                img.onload = function () {
                    var html = '<img src="http://image.yinxindata.com/' + src + '" style="max-width:100%;"/>';
                    editor.command(event, 'insertHtml', html);

                    E.log('已插入图片，地址http://image.yinxindata.com/ ' + src);
                    img = null;
                };
                img.onerror = function () {
                ...
                img.src = 'http://image.yinxindata.com/' + src;
            }
